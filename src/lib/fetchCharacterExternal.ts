// src/lib/characters/fetchCharacterExternal.ts
...
export const fetchCharacterExternal = async (characterName: string, server: string): Promise<ExtraCharacterData> => {
	...
	const data = (await res.json()) as { ranks: ExtraCharacterData[] };
